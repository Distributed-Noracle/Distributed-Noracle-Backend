...
import i5.las2peer.services.noracleService.INoracleQuestionRelationService;
...
import i5.las2peer.services.noracleService.QuestionRelation;
import i5.las2peer.services.noracleService.QuestionRelationList;
...
public class QuestionRelationsResource implements INoracleQuestionRelationService {
	...
	@ApiResponses({ @ApiResponse(
			...
			@ApiResponse(
					...
					response = ExceptionEntity.class) })
	public QuestionRelation createQuestionRelation(@PathParam("spaceId") String spaceId,
			CreateRelationPojo createRelationPojo) throws ServiceInvocationException {
		return createQuestionRelation(spaceId, createRelationPojo.getName(), createRelationPojo.getQuestionId1(),
